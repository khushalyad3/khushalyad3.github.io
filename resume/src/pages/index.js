              ...
              <div className={styles.coverImageOverlay}>
                <div className={styles.aboutME}>
                  <motion.div
                    ...
                    <h1 className='bd1'>SOFTWARE ENGINEER</h1>
                    <span style={{ height: "14vh", width: "100%", display: "flex", flexWrap: "wrap" }}>
                      <h4>{code0}</h4>
...
export const Titles = (titles) => {
  return (
    <>
      <h3 style={{ fontWeight: "600" }}>{titles}</h3>
    </>)
}
